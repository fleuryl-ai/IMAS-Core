    ...
    try {
        ...
        // 1. Writing
        {
            ...
            for (int t = 0; t < time_steps; ++t) {
                ...
                backend.writeData(&profilesCtx, "signal_1d_bis", "time", val_bis.data(), alconst::double_data, sig_dim, sig_size);
        ...
        // 2. Reading / Validation
        {
            ...
            for (int t = 0; t < time_steps; ++t) {
                ...
                backend.readData(&profilesCtx, "signal_1d_bis", "time", &data, &type, &dim, size);
                assert(dim == 1);
                assert(size[0] == spatial_size);
                ...
                backend.readData(&profilesCtx, "string_1d", "time", &str_1d_data, &str_1d_type, &str_1d_rdim, str_1d_rsize);
